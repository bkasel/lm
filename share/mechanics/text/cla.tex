...
\begin{equation*}
        (T_{af}-T_{ai})(m_a)/(0.42\ \gunit)         =      (T_{ci}-T_{cf})(m_c)/(0.24\ \gunit) \qquad .
\end{equation*}
...
\begin{equation*}
                (T_f-T_{ai})(m_a)/(0.42\ \gunit)         =      (T_{ci}-T_f)(m_c)/(0.24\ \gunit) \qquad .
\end{equation*}
...
\begin{equation*}
 \Delta t=1\ \zu{day}\times\frac{24\ \zu{hours}}{1\ \zu{day}}\times\frac{60\ \zu{min}}{1\ \zu{hour}}\times\frac{60\ \sunit}{1\ \zu{min}}=9\times10^4\ \sunit \qquad .
\end{equation*}
