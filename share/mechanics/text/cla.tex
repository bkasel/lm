...
As described on p.~\pageref{ke-why-one-half}, it's different in different systems of units. 
...
What about the proportionality it $v^2$? Here are some points to consider:
\begin{enumerate}
...
\item The proportionality to $v^2$ is not even quite
correct; experiments show deviations from the $v^2$
rule at high speeds (figure \figref{ke-of-electrons}), an effect that is related to Einstein's
theory of relativity.
\item As described in the preceding subsection,
...
\end{enumerate}
The most we can say is that \emph{under a certain set of low-velocity approximations}, $KE\propto v^2$
is what works.

Some people like to say that $KE=(1/2)mv^2$ is just a theorem that can be proved mathematically.
This is known as the work-energy theorem. The fact that $KE\propto v^2$ is only approximately true
should remind us that a proof is only as good as the assumptions that went into it. This approach is
also, in my opinion, a little backwards, because it purports to derive a conservation law from Newton's
laws --- conservation laws are more general than Newton's laws.
