...
<% end_sec() %>
<% end_sec() %>
<% begin_sec("All Energy is Potential or Kinetic",0) %>
...
\end{indentedblock}
\begin{indentedblock}
\textbf{electrical and magnetic potential energy}
\end{indentedblock}
\begin{indentedblock}
\textbf{nuclear potential energy}
\end{indentedblock}
