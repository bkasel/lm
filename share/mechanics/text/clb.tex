...
absolute temperature, $P\propto T^4$. We can easily understand the reason for radiation based on the
...
they constitute visible light (see section \ref{sec:em-spectrum}, p.~\pageref{sec:em-spectrum}). In figure \figref{plutonium-glowing}, the nuclear and electrical potential energy
...
warming all by themselves, so nuclear power is also a critical piece of the puzzle (see also
