...
\begin{equation*}
                \tau_{total}  =  \frac{\Delta L}{\Delta t}   \qquad   .
\end{equation*}
...
momentum, we have
\begin{align*}
  F & = \frac{m\Delta v}{\Delta t} \qquad . \\
...
\begin{equation*}
                F_{\perp}    =    |\vc{F}| \sin  \theta    \qquad   ,
\end{equation*}
leading to
\begin{equation*}
                |\btau|    =    r |\vc{F}| \sin   \theta    \qquad   .
\end{equation*}
\end{eg}
...
\begin{equation*}
                r_{cable} |F_{cable}| \sin   \theta_{cable} - r_{grav}|F_{grav}|\sin  \theta_{grav}  =  0   \qquad   .
\end{equation*}
A little geometry gives $\theta_{cable}=90\degunit-\alpha$ and $\theta_{grav}=\alpha$, so
\begin{equation*}
                r_{cable} |F_{cable}| \sin   (90\degunit-\alpha) - r_{grav}|F_{grav}| \sin   \alpha  =  0   \qquad   .
\end{equation*}
...
\begin{equation*}
                2 |F_{cable}| \sin   (90\degunit-\alpha) - |F_{grav}| \sin   \alpha =  0   \qquad   .
\end{equation*}
...
\begin{equation*}
                2 |F_{cable}| \cos  \alpha - |F_{grav}| \sin   \alpha  =  0   \qquad   ,
\end{equation*}
...
\begin{equation*}
                r_{muscle} F_{muscle}  =  r_{load} F_{arm}   \qquad   ,
\end{equation*}
