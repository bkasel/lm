...
\begin{equation*}
        \frac{\lambda}{d} \leftrightarrow \theta_Z \qquad .
\end{equation*}
...
\begin{multline*}
        \frac{\lambda}{d} = \frac{\sin\theta}{m} \qquad . \hfill
                  \shoveright{\text{[condition for a maximum;}}\\
                  \text{$m$ is an integer]}
\end{multline*}
...
\begin{equation*}
        \frac{\lambda}{a} \leftrightarrow \theta \qquad .
\end{equation*}
