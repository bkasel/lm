%%%%%
%%%%% This problem is used by: 5op,2,invertedforehead 7cp,7,invertedforehead
%%%%%
In figure \subfigref{real-and-virtual}{2} in on page \pageref{fig:real-and-virtual}, only the image of my
